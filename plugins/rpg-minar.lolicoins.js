...
if (new Date - user.lastcoins < 600000) return await conn.reply(m.chat, `*[ ❗️𝗜𝗡𝗙𝗢𝗥𝗠𝗔𝗖𝗜𝗢𝗡 ❗️]\n\n*VUELVA EN ${msToTime(time - new Date())} PARA CONTINUAR MINANDO ${global.rpgshopp.emoticon('money')}⏰*`, fkontak,  m)

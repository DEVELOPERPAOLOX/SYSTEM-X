...
if (new Date - user.lastdiamantes < 900000) return await conn.reply(m.chat, `👋🏻𝐒𝐚𝐥𝐮𝐝𝐨𝐬 𝐮𝐬𝐮𝐚𝐫𝐢𝐨!\𝐧🚀𝐕𝐮𝐞𝐥𝐯𝐞  𝐚 𝐮𝐬𝐚𝐫 𝐞𝐥 𝐜𝐨𝐦𝐚𝐧𝐝𝐨 𝐞𝐧 ${msToTime(time - new Date())} 𝐩𝐚𝐫𝐚 𝐪𝐮𝐞 𝐩𝐮𝐞𝐝𝐚𝐬 𝐜𝐨𝐧𝐭𝐢𝐧𝐮𝐚𝐫 𝐦𝐢𝐧𝐚𝐧𝐝𝐨. ${global.rpgshopp.emoticon('limit')}⛏️*`, fkontak,  m, fake,)

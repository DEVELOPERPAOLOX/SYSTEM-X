...
global.fake = { contextInfo: { mentionedJid: conn.parseMention(wm), forwardingScore: 1, isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363316264159575@newsletter', serverMessageId: '', newsletterName: '✅ ＣＡＮＡＬ | ＳＹＳＴＥＭ Ｘ' }, externalAdReply: { title: wm, body: `👋𝐒𝐚𝐥𝐮𝐝𝐨𝐬 𝐮𝐬𝐮𝐚𝐫𝐢𝐨` + nombre, mediaType: 1, renderLargerThumbnail: false, previewType: `PHOTO`, thumbnailUrl: imagen1, thumbnail: imagen1, sourceUrl: yt }}}, { quoted: m } //fake con reenviado de canal
}
